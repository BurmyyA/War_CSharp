...
namespace War_Burmeister
{
    public partial class WarForm : Form
    {
        ...
        private void restartButton_Click(object sender, EventArgs e)
        {
            ...
            while(mainDeck.CountRemainCards() > 0)
            {
        ...
        private void playButton_Click(object sender, EventArgs e)
        {
            ...
            if (playerDeck.CountRemainCards() == 0)
            {
                ...
                {
                    MessageBox.Show("You have won!", "GG's");
                }
                else if (computerScore > playerScore)
                {
                    MessageBox.Show("You have lost!", "GG's");
                }
                else
                {
                    MessageBox.Show("It was a tie!", "GG's");
                }
            }
        }
